...
class Note extends ModelBase {
  ...
  Note({this.id,required this.title,required this.body,required this.date,required this.idCategory});
  ...
  dynamic create(Map<String, dynamic> map) {
    return Note(id: map['id'] != null ? map['id'] : null, title: map['title'], body: map['body'] ?? '',
            date: map['date'] ?? '',idCategory: map['id_category']);
  }
